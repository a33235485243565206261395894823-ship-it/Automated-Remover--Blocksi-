...
If the user wishes they may create a shortcut, it is a link to the `.bat` and can be displayed on the desktop or be pinned to the taskbar. Users could use the `ico` file provided as the icon for this file or create their own. Instructions are in the README.
